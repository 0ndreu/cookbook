...
from OuiCheff.views import FridgeViewSet, ProductViewSet, ReceiptsViewSet, ReceiptHasProductView, GiveDishView
...
router.register('GiveDishView', GiveDishView, base_name='GiveDishView')
